...
package Fluid_StreamLines.nogit;
...
public class Streamlines_Mod extends PApplet {
  ...
  private class MyFluidData implements DwFluid2D.FluidData{
    ...
    public void update(DwFluid2D fluid) {
      ...
      if(mouse_input && mouseButton == RIGHT){
        ...
        vy     = (mouseY - pmouseY) * -vscale;
        radius = 30;
        fluid.addDensity(px, py, radius, 10, 1, 1f, 1f, 1);
        radius = 20;
        temperature = 1;
        fluid.addTemperature(px, py, radius, temperature);
      }
  ...
  public DwFluidStreamLines2D streamlines;
...
//    frameRate(1000);
  ...
  public void saveImage(){
    ...
    file = new File(file.getParent()+"/out", millis+"_"+this_.getSimpleName()+"_screenshot.png");
...
//    .setPosition(20, 40)
  ...
  public static void main(String args[]) {
    PApplet.main(new String[] { Streamlines_Mod.class.getName() });
  }
}